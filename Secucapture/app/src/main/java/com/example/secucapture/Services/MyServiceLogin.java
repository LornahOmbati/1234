...
import com.example.secucapture.Activities.LoginActivity;
...
public class MyServiceLogin extends Service {
    ...
    public void onCreate() {
        ...
        // initializations when service is created.
    ...
    //when the service os started, on start command is invoked, it then sends a message to service handler to start login process.
    @Override
    ...
    //This handler handles the login process, it constructs a JSON object containing login credentials and other necessary info using the login method.
    ...
    //constructed during the login process by service handler
...
//            json.put("UserName", LoginActivity.user1);
    ...
    // This method sends a POST request to the specified URL with JSON data. It uses OkHttp library to make the HTTP request asynchronously. The response is processed in the Callback interface.
        ...
        switch (SW)
        {
            case "JobLogin":
                ...
                try {
                    ...
                    editor.putString("password", LoginActivity.password1);
                    editor.apply();
